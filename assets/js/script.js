...
/**
* Main card array with 20 favIcons (class names)
*/
const iconArray = [
...
/**
* Game timer, controlls the time and result of game.
* I learned how to do the progress bar by reading at:
...
/**
 * Function that restores end game message
 */
...
/**
* Function that controlls the face value of the picked and send
* pairs to the cardsPaird Array.
*/
